...
$email = "hudante1".rand(000000,9999999)."@gmail.com"; /// Edit Sama email Lo
$username = "randialw_".rand(000000,9999999);  /// Edit Username yg u inginkan
#$password = $username.randd();
$password = "katasandi7";  /// Edit password yg u inginkan
